 ...
 * right border at vertical centre, a chevron flipping to point the
 * direction the rail's edge is about to move -- the convention several
 * dashboard toolkits (Bootstrap, Tailwind UI) use, rather than a full-width
