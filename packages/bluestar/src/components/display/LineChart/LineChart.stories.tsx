...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          "Multi-series time-series line chart with a legend, direct end-labels, a crosshair+tooltip, and a table-view toggle. All series share one y-axis -- never a dual scale.",
      },
    },
  },
